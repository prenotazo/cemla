	...
	<form id='registerPageMonitored' action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
		<fieldset>
			...
			<div class='container'>
			    ...
			    <input type='text' name='monitoredUrl' id='monitoredUrl' value='<?php echo $pageMonitored['url']; ?>' maxlength="256"/><br/>
			    <span id='register_monitoredUrl_errorloc' class='error'></span>
			</div>
			<div class='container'>
			    <label for='checkFrequencyMin'>Check Frequency (Minutes)*:</label><br/>
			    <input type='text' name='checkFrequencyMin' id='checkFrequencyMin' value='<?php echo $pageMonitored['checkFrequencyMin']; ?>' maxlength="50"/><br/>
			    <span id='register_checkFrequencyMin_errorloc' class='error'></span>
			</div>
			<div class='container'>
			    <label for='lastCheckDone'>Last Check Done:</label><br/>
			    <input type='text' disabled="disabled" name='lastCheckDone' id='lastCheckDone' value='<?php echo $pageMonitored['lastCheckDone']; ?>' maxlength="50"/><br/>
			</div>
			<div class='container'>
			    <label for='lastChangeDetected' >Last Change Detected:</label><br/>
			    <input type='text' disabled="disabled" name='lastChangeDetected' id='lastChangeDetected' value='<?php echo $pageMonitored['lastChangeDetected']; ?>' maxlength="50"/><br/>
			</div>
